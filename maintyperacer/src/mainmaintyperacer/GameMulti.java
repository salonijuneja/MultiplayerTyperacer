...
float ispeed;
    ...
    public GameMulti(String username,int a,Socket sock) {
         initComponents();
        user=username;
        this.sock=sock;
        showPara(a);
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(240, 270, 160, 40);
      ...
      // Enter was pressed. Your code goes here.
        ...
        char ch = evt.getKeyChar();
            ...
            Logger.getLogger(login.class.getName()).log(Level.SEVERE, null, ex);
                          ...
                          output.println("##"+user+"_"+a+"_"+speed);
                          // System.out.println("##"+user+","+a+","+speed+",53");
                           output.flush();
                          } catch (IOException ex) {
                              Logger.getLogger(GameMulti.class.getName()).log(Level.SEVERE, null, ex);
                          }
                          this.setVisible(false);
